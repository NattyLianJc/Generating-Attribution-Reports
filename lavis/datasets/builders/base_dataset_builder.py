...
class BaseDatasetBuilder:
    ...
    def __init__(self, cfg=None):
        ...
        self.data_type = self.config.data_type  # 'images'
    ...
    def build(self):
        ...
        build_info = self.config.build_info  # defaults_cap.yaml+caption_coco_ft.yaml:dataset

        ann_info = build_info.annotations
        vis_info = build_info.get(self.data_type)

        datasets = dict()
        for split in ann_info.keys():   # ["train", "val", "test"]
