...
class RunnerBase:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            # {'train': [<lavis.datasets.datasets.caption_datasets.CaptionDataset at 0x7fa3605ef9a0>],
            #  'val': [<lavis.datasets.datasets.coco_caption_datasets.COCOCapEvalDataset at 0x7fa3605ef7f0>],
            #  'test': [<lavis.datasets.datasets.coco_caption_datasets.COCOCapEvalDataset at 0x7fa3605ef4f0>]}
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):  # self.max_epoch
            # training phase
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        results, loss = self.task.evaluation(model, data_loader)

        self.log_stats(loss, split_name)
