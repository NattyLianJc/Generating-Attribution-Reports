...
class Blip2T5(Blip2Base):
    ...
    def forward(self, samples):
        ...
        with self.maybe_autocast(dtype=torch.bfloat16):
            ...
            output_tokens = self.t5_tokenizer(
                samples["label"],  # samples["text_output"]\samples["caption"]
                padding="longest",
                truncation=True,
                max_length=self.max_txt_len,
                return_tensors="pt",
            ...
            idxs = (output_tokens.input_ids >= 32000) & (output_tokens.input_ids <= 32099)
            targets = targets.masked_fill(idxs, -100)
    ...
    def from_config(cls, cfg):
        ...
        max_txt_len = cfg.get("max_txt_len", 150)  # 32
