...
#SBATCH --output=/scratch-shared/ljc-1/dff/slurm_output/test_both1.out
#SBATCH --error=/scratch-shared/ljc-1/dff/slurm_output/test_both1.err
...
# python test.py \
#     --json_file_path dataset/eval-mutilabel_both.json \
#     --output_text_file both_captions.json \
#     --output_mask_dir both_mask \
#     --image_base_dir dataset
python test.py \
    --json_file_path dataset/eval-mutilabel_both_05x_11.json \
    --output_text_file both_05x_11_captions.json \
    --output_mask_dir both_05x_11_mask \
    --image_base_dir dataset