...
#SBATCH --output=/scratch-shared/ljc-1/dff/slurm_output/test_blur1.out
#SBATCH --error=/scratch-shared/ljc-1/dff/slurm_output/test_blur1.err
...
# python test.py \
#     --json_file_path dataset/eval-mutilabel_blur.json \
#     --output_text_file blur_captions.json \
#     --output_mask_dir blur_mask \
#     --image_base_dir dataset
python test.py \
    --json_file_path dataset/eval-mutilabel_blur_11.json \
    --output_text_file blur_11_captions.json \
    --output_mask_dir blur_11_mask \
    --image_base_dir dataset